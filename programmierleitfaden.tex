...
Es gibt an der \FVA{n} recht viele Menschen, die programmieren und nur wenige,
die dies richtig gelernt haben. Wenn wir uns auf einen gemeinsamen Satz von
Regeln einlassen k\"o{}nnen, werden wir den Code unserer Kolleginnen
...
Menschen deinen Code zu zeigen um zu sehen, was sie davon halten.
...
\item[TODO:] Hier gibt es etwas zu verbessern. Aber der Code tut, was er soll.
  Vielleicht ist er h\"a{}sslich, %TODO: h\"a{}\ss{}lich?
...
{query_package_names.r} %TODO: rownames()?
...
ohne Support ist sie unter der %TODO: \href{?}{AGPL v3}
AGPL v3 ver\"o{}ffentlicht.
...
lateinische Alphabet beschr\"a{}nken mussten. %TODO: mu\ss{}ten?
