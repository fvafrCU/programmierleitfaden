...
\lstinputlisting[float=h, label=lst:rpackages, firstline = 2]{query_package_names.r}
...
\lstinputlisting[float=h, label=lst:if1, firstline = 2]{if_1.r}
Das macht das Ganze zwar nicht v\"o{}llig unverst\"a{}ndlich, aber
Listing~\ref{lst:if2} ist deutlich lesbarer:
\lstinputlisting[float=h, label=lst:if2, firstline = 2]{if_2.r}
